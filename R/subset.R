#' @name Filter_Subset
#' @rdname Filter_Subset
#' @title Filter und Subset
#' @rdname CleanUp
#' @description \code{Drop_NA} entfernt Fälle mit NAs mit \code{dplyr::filter}
#' @export
#' @examples
...
output_droped_n<- function(N=0, n1=N, txt=""){
  HTML_B(paste0("Filter: ", txt, " (N =", N,  "/", n1, ")"))
}
